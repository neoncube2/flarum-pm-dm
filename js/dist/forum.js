...
var ConversationView = /*#__PURE__*/function (_Component) {
  ...
  _proto.onbeforeupdate = function onbeforeupdate() {
    ...
    $('#MessageTextArea').off().on('keydown', function (e) {
      if (e.keyCode === 13 && flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().forum.attribute('whisperReturnKey')) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      className: "chat-with"
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().translator.trans('littlecxm-whisper.forum.chat.chat_with', {
      username: flarum_common_helpers_username__WEBPACK_IMPORTED_MODULE_4___default()(this.user)
    })), m("div", {
      className: "chat-num-messages"
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().translator.trans('littlecxm-whisper.forum.chat.messages_' + (parseInt(this.conversation.totalMessages()) > 1 ? 'multiple' : 'single'), {
    ...
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().translator.trans('littlecxm-whisper.forum.chat.start_of_conversation')) : '', messages ? messages.filter(function (message, index, self) {
      ...
      placeholder: flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().translator.trans('littlecxm-whisper.forum.chat.text_placeholder'),
      rows: "3"
    ...
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().translator.trans('littlecxm-whisper.forum.chat.send'))));
  };
  _proto.typingPush = function typingPush(value) {
    ...
    if (this.typingTimeout) {
      flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().request({
        method: 'POST',
        url: flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().forum.attribute('apiUrl') + '/whisper/messages/typing',
        body: {
  ...
  _proto.sendMessage = function sendMessage() {
    ...
    flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().store.createRecord('messages').save({
      ...
      flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().request({
        method: 'POST',
        url: flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().forum.attribute('apiUrl') + '/whisper/messages/read',
        body: {
  ...
  _proto.getMessages = function getMessages(offset) {
    ...
    flarum_forum_app__WEBPACK_IMPORTED_MODULE_11___default().store.find('whisper/messages', this.conversation.id(), {
      offset: offset
...
var ConversationViewPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.init = function init() {
    ...
    app.store.find('whisper/conversations', idParam).then(function (conversation) {
...
var ConversationsDropdown = /*#__PURE__*/function (_NotificationsDropdow) {
  ...
  ConversationsDropdown.initAttrs = function initAttrs(attrs) {
    attrs.label || (attrs.label = flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('littlecxm-whisper.forum.dropdown.tooltip'));
...
var ConversationsList = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_6___default().forum.attribute('canMessage') ? flarum_forum_app__WEBPACK_IMPORTED_MODULE_6___default().translator.trans('littlecxm-whisper.forum.chat.start') : flarum_forum_app__WEBPACK_IMPORTED_MODULE_6___default().translator.trans('littlecxm-whisper.forum.chat.cant_start')), hasConversations && m("ul", {
  ...
  _proto.loadMore = function loadMore() {
    ...
    this.loading = true;
    m.redraw();
    flarum_forum_app__WEBPACK_IMPORTED_MODULE_6___default().store.find('whisper/conversations', {
  ...
  _proto.load = function load() {
    ...
    this.loading = true;
    m.redraw();
    flarum_forum_app__WEBPACK_IMPORTED_MODULE_6___default().store.find('whisper/conversations').then(function (results) {
      delete results.payload;
...
var RecipientSearch = /*#__PURE__*/function (_Search) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      type: "search",
      placeholder: flarum_common_utils_extractText__WEBPACK_IMPORTED_MODULE_5___default()(flarum_forum_app__WEBPACK_IMPORTED_MODULE_10___default().translator.trans('littlecxm-whisper.forum.modal.search_recipients')),
      value: this.value(),
    ...
    }), m("li", null, m("span", null, flarum_forum_app__WEBPACK_IMPORTED_MODULE_10___default().translator.trans('littlecxm-whisper.forum.modal.more_users'))))) : m("div", {
...
var StartConversationModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return flarum_forum_app__WEBPACK_IMPORTED_MODULE_7___default().translator.trans('littlecxm-whisper.forum.modal.title');
  };
  ...
  _proto.content = function content() {
    return [m("div", {
    ...
    }, this.already ? [m("h2", null, flarum_forum_app__WEBPACK_IMPORTED_MODULE_7___default().translator.trans('littlecxm-whisper.forum.modal.already', {
      username: flarum_common_helpers_username__WEBPACK_IMPORTED_MODULE_4___default()(this.recpient)
    })), m("h2", null, flarum_forum_app__WEBPACK_IMPORTED_MODULE_7___default().translator.trans('littlecxm-whisper.forum.modal.copied', {
      username: flarum_common_helpers_username__WEBPACK_IMPORTED_MODULE_4___default()(this.recpient)
    }))] : m("div", null, m("div", {
      "class": "helpText"
    }, (flarum_forum_app__WEBPACK_IMPORTED_MODULE_7___default().cache).conversationsRecipient !== null ? flarum_forum_app__WEBPACK_IMPORTED_MODULE_7___default().translator.trans('littlecxm-whisper.forum.modal.help_start', {
    ...
    }) : flarum_forum_app__WEBPACK_IMPORTED_MODULE_7___default().translator.trans('littlecxm-whisper.forum.modal.help')), m("div", {
      ...
      placeholder: flarum_forum_app__WEBPACK_IMPORTED_MODULE_7___default().translator.trans('littlecxm-whisper.forum.chat.text_placeholder'),
      rows: "3"
    }), flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default().component({
      type: 'submit',
      className: 'Button Button--primary',
      disabled: !this.messageContent()
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_7___default().translator.trans('littlecxm-whisper.forum.modal.submit'))) : '')))];
  };
...
/* harmony import */ var _models_Message__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/Message */ "./src/forum/models/Message.js");
/* harmony import */ var _models_Conversation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/Conversation */ "./src/forum/models/Conversation.js");
/* harmony import */ var _models_ConversationUser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/ConversationUser */ "./src/forum/models/ConversationUser.js");
...
/* harmony import */ var _components_ConversationsPage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/ConversationsPage */ "./src/forum/components/ConversationsPage.js");
/* harmony import */ var _components_ConversationViewPage__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/ConversationViewPage */ "./src/forum/components/ConversationViewPage.js");
...
/* harmony import */ var _addConversationsDropdown__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./addConversationsDropdown */ "./src/forum/addConversationsDropdown.js");
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('littlecxm-whisper', function (app) {
  app.store.models.messages = _models_Message__WEBPACK_IMPORTED_MODULE_3__["default"];
  app.store.models.conversations = _models_Conversation__WEBPACK_IMPORTED_MODULE_4__["default"];
  app.store.models.conversation_users = _models_ConversationUser__WEBPACK_IMPORTED_MODULE_5__["default"];
  (flarum_common_models_User__WEBPACK_IMPORTED_MODULE_6___default().prototype).conversations = flarum_common_Model__WEBPACK_IMPORTED_MODULE_7___default().hasMany('conversations');
  (flarum_common_models_User__WEBPACK_IMPORTED_MODULE_6___default().prototype).unreadMessages = flarum_common_Model__WEBPACK_IMPORTED_MODULE_7___default().attribute('unreadMessages');
  app.routes.conversations = {
    path: '/whisper/conversations',
    component: _components_ConversationsPage__WEBPACK_IMPORTED_MODULE_8__["default"]
  };
  app.routes.messages = {
    path: '/whisper/messages/:id',
    component: _components_ConversationViewPage__WEBPACK_IMPORTED_MODULE_9__["default"]
  };
  (0,_addConversationsDropdown__WEBPACK_IMPORTED_MODULE_11__["default"])();
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'oncreate', function () {
    if (app.pusher) {
      app.pusher.then(function (object) {
        ...
        if (channels.user) {
          channels.user.bind('newMessage', function (data) {
            app.session.user.unreadMessages = flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_10___default()(app.session.user.unreadMessages() + 1);
            m.redraw();
          });
        }
      });
